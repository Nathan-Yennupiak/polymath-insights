...
const Hero = () => {
    return (
        <div className="lg:px-40 px-4 py-20 flex flex-col md:flex-row gap-10 lg:gap-2 bg-primary-gray mb-10">
            <div className="flex flex-col space-y-4 justify-center flex-1 text-center md:text-left">
                <h1 className="capitalize text-5xl lg:text-7xl font-bold ">A blog for all ages & website lovers</h1>
